"""
    This .py is intended to test if the circuit board could work.
    So it will only setup PWM output.
    Please check the voltage of the circuit.
"""
...
while True:
    ...
    if pwm0_data >= 1024:
        pwm0 = 1023
#     pwm0.duty(pwm0_data)  # 仅仅是测试, 先取消设置
