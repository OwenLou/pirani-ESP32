...
oled_i2c = SoftI2C(scl=Pin(22), sda=Pin(21), freq=100000)  # Init i2c 如果是esp32，SCL接22口、SDA接21口
...
while True:
    ...
    print(adc0_data, adc0_V)
    oled.text(str(adc0_data)+' '+str(adc0_V),0,0,0)
    oled.show()
    time.sleep(1)
